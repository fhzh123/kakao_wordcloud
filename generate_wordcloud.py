...
def generate_wordcloud(args):
    text_dat = pd.read_csv(os.path.join(args.data_path, args.data_name+'_preprocessed.csv'))
    ...
    plt.savefig(os.path.join(args.image_path, args.data_name+'.jpg'))
    plt.axis("off")
    plt.show()